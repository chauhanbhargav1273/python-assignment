...
urlpatterns = [
    ...
    path('seller-view-leptop/',views.seller_view_leptop,name='seller-view-leptop'),
    ...
    path('ajax/validate_login/',views.validate_login,name='vlidate_login'),
    path('ajax/oldpass/',views.oldpass,name='oldpass'),
    path('ajax/validate_addpro/',views.validate_addpro,name='vlidate_addpro'),
]